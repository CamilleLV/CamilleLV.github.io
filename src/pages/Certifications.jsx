...
const certificates = [
  {
    ...
    skills: ["Machine Learning", "Model Choice", "Operating LLMs"],
  ...
  },
  {
    ...
    organization: "ETS",
    category: "Professional",
    skills: ["English", "800/990"],
    image: "/images/TOEIC.png"
  },
  {
    id: 3,
    title: "EuroGames Lyon 2025 Academy Volunteer Program",
    organization: "EUROGAMES",
    category: "Community",
    skills: ["Inclusivity", "Transgender inclusion in sports"],
    image: "/images/EuroGames_Lyon2025.jpg"
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className={`text-xl ${styles.textSecondary} max-w-3xl mx-auto`}>
            Here are some certifications I received alongside my studies.
          </p>
        </div>
