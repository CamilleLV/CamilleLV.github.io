...
const projects = [
  {
    ...
    description: "Developing a Java Swing application for users to explore and analyze a map graph of locations and routes.",
    image: "./public/images/PortfolioImage_GraphMap.png",
    technologies: ["Java Swing"],
    status: "Completed",
    github: "https://github.com/CamilleLV/Java_Graph_MAP",
    live: "#",
    forks: 0,
    stars: 0
  },
  {
    id: 2,
    title: "Snake Game",
    description: "A classic arcade game where you control a snake that grows longer with everything it eats.",
    image: "./public/images/PortfolioImage_SnakeGame.png",
    technologies: ["Javascript", "HTML", "CSS"],
    status: "Completed",
    github: "https://github.com/CamilleLV/Jeu_Du_Snake",
    live: "#",
    forks: 4,
    stars: 12
  },
  {
    ...
    description: "A Java simulation that models and visualizes the spread of fire through a forest grid.",
    image: "./public/images/PortfolioImage_FeudeForet.png",
    technologies: ["Java"],
    status: "Completed",
    github: "https://github.com/CamilleLV/Simulation_Feu_de_Foret",
    live: "#",
    forks: 4,
    stars: 12
  },
  {
    id: 4,
    title: "MyList",
    description: "Inspired by recommendation sites for shows and movies, we created MyList, a tracking platform allowing users to follow their favorite movie.",
    image: "./public/images/PortfolioImage_MyList.png",
    technologies: ["PHP", "HTML", "Javascript", "CSS"],
    status: "Completed",
    github: "https://github.com/CamilleLV/MyList",
    live: "#",
    forks: 4,
    stars: 12
  },
  {
    ...
    description: "Gained proficiency in data visualization and analytics platforms like Power BI, Tableau, Dataiku DSS, and KNIME through my university coursework.",
    image: "./public/images/PortfolioImage_PowerBI.png",
    technologies: ["PowerBI", "Tableau", "Dataiku DSS", "KNIME"],
    status: "You're never done learning.",
    github: "https://github.com/CamilleLV/BIA_PTUT_Data_Governance",
    live: "#",
    forks: 4,
    stars: 12
  }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className={`text-lg md:text-xl ${styles.textSecondary} max-w-3xl mx-auto`}>
              Exploring My Academic and Personal Projects
            </p>
          </div>
          {/* Status Filter */}
