...
const themeStyles = {
  icy: {
    ...
    heart1: "text-red-600",
    heart2: "text-green-600",
    heart3: "text-yellow-600"
  },
  hot: {
...
const emailInitial = "camille.laverie";
const emailDomains = [
...
const contactInfo = [
  {
    ...
    link: "mailto:camille.laverie@gmail.com",
  ...
  },
  {
    ...
    label: "Phone",
    value: "+33 632432323",
    link: "tel:+33632432323",
    description: "Text me first, I don't answer anonymous calls"
  },
  {
    icon: <FaMapMarkerAlt />,
    label: "Location",
    ...
    description: "caput Galliarum (I can moove everywhere.)"
  }
];
...
const socialLinks = [
  {
    icon: <FaGithub />,
    name: "GitHub",
    url: "https://github.com/CamilleLV",
    color: "text-gray-800 dark:text-gray-200",
    description: "Student projects only"
  },
  {
    icon: <FaLinkedin />,
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/camille-laverie/",
    color: "text-blue-600",
  ...
  },
  {
    ...
    url: "https://www.linkedin.com/in/camille-laverie/",
    color: "text-red-500",
    description: "When I was still doing video editing"
  },
  {
    icon: <FaInstagram />,
    name: "Instagram",
    url: "https://www.instagram.com/camille_lvrrr/",
    color: "text-purple-500",
    description: "Because a lot of people do like my stories"
  }
];
      ...
      <div className="mb-16 flex flex-col items-center justify-center">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className={`text-xl ${styles.textSecondary} max-w-3xl mx-auto leading-relaxed`}>
            Available for hot chocolate and exciting new projects ! 
          </p>
        </div>
      </div>
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          ...
          <p className={`${styles.textSecondary} text-lg`}>
            Let's connect on LinkedIn for handshakes, and on Instagram for high-fives.
          </p>
        </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className={`text-sm ${styles.textSecondary} text-center md:text-left break-words w-full`}>
                <p className="flex items-center justify-center md:justify-start gap-2 flex-wrap break-all w-full">
                  © {currentYear} Camille Laverie.
                  <FaHeart className={`${styles.heart1} animate-pulse`} />
                  <FaHeart className={`${styles.heart2} animate-pulse`} />
                  <FaHeart className={`${styles.heart3} animate-pulse`} />
                </p>
              </div>
