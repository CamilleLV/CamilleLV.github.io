      ...
      {images.map((src, i) => (
        <img
          ...
          className={`
            ...
            profile-img-fade profile-img-organic
...
function LandingPage() {
  ...
  // Typewriter effect
  useEffect(() => {
    const typeSpeed = isDeleting ? 15 : 60;
          ...
          <div className="relative z-10">
            ...
            <div className="mb-8 text-center md:text-left">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 animate-fade-in">
                ...
                <span className="ml-3">Salut !</span>
              </h1>
            ...
            <div className={`space-y-4 mb-10 ${accents.text} text-center md:text-left`}>
              <p className="text-lg md:text-xl leading-relaxed animate-fade-in-up">
                 <span className={`${accents.highlight} font-semibold`}>
                  Data Professional
                  </span> - PowerBI, ETLs, SQL...
              </p>
            </div>
              <TypewriterText currentText={"Data " + currentText} accents={accents} />
            </div>
